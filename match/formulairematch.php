					...
					//   print_r($count);
				 	 if ($count->rowCount()!=0) {
				 		...
				 		echo "Le match existe déjà.";
				 	 	...
				 	 	$requete = "INSERT INTO matchs(datem, heure, adversaire, lieu, contexte, id_set) VALUES ('$datem', '$heure','$adversaire','$lieu','$contexte','$idset')";
					 	var_dump($requete);	
				 	 	$bdd->exec($requete);
						
				 		//apprendre comment on met une pop-up
