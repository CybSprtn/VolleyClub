...
<html>
    ...
    <body>
		...
		<div class="container">
			...
			if (isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['num_licence']) && isset($_POST['date_naissance']) && isset($_POST['taille']) && isset($_POST['poids']) && isset($_POST['statut']) && isset($_POST['poste_pref'])) {
